...
time_values = [
    ...
    3705, 3742, 3758, 3783, 3796, 3821, 3835, 3852, 3874, 3890, 3911, 3933, 3955, 
    3989, 4003, 4075, 4098, 4202, 4210
]
...
load_labels = [
    "10 second load", "5 second load", "2.5 second load", 
    "1 second load", "0.5 second load", "0.25 second load", "0.5 second load",
    "1 second load", "2.5 second load", "5 second load", "10 second load"
]
...
for i in range(len(time_values) - 1):
    ...
    fig.add_annotation(
        x=midpoint,
        y=(data['y_diff'].min() + data['y_diff'].max()) / 2,  # Placing in the middle of y-axis range
        text=label,
        showarrow=False,
        yshift=y_shift,
